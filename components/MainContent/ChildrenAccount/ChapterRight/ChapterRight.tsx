        ...
        <WrapperChapter>
            {arrayItems.map(({title,text,icon}) => (
                <ItemBlockRight>
                    ...
                    <TextBlockRight>
                        <TitleBlock><TitleItemRight fontSize='20px' fontWeight='600' lineH='27px'>{title}</TitleItemRight></TitleBlock>
                        <SubtitleBlock><SubtitleItemRight fontSize='16px' fontWeight='300' lineH='25px'>{text}</SubtitleItemRight></SubtitleBlock>
                    </TextBlockRight>
                </ItemBlockRight>
            ))}
        </WrapperChapter>
