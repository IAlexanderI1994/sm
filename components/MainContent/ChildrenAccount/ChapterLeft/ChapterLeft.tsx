    ...
    return (
        <WrapperChapter>
            {arrayItems.map(({title,text,icon}) => (
                <ItemBlockLeft>
                    <TextBlockLeft>
                        <TitleBlock><TitleItemLeft fontSize='20px' fontWeight='600' lineH='27px'>{title}</TitleItemLeft></TitleBlock>
                        <SubtitleBlock><SubtitleItemLeft fontSize='16px' fontWeight='300' lineH='25px'>{text}</SubtitleItemLeft></SubtitleBlock>
                    </TextBlockLeft>
                    <IconBlock>
                        <IconImage src={icon}/>
                    </IconBlock>
