            ...
            <ContainerAboutSchool>
                <ViewBlock  viewDirection='column' positionView='relative' >
                    <View viewDirection='column'>
                        ...
                        >
                            Официальная сеть школ ФК «Спартак-Москва»
                            Набор детей от 4 лет!
                        </TitleAbout>
                        <ButtonAbout>
                            <TitleAboutButton lineH='31px' fontSize='20px' fontWeight='600' textTr='uppercase '>Бесплатное Занятие</TitleAboutButton>
                        </ButtonAbout>
                    </View>
                    <VideoBlock>
                        <WrapperPlay>
                        ...
                        <WrapperTitlePlay><TitlePlay lineH='31px' fontSize='20px' fontWeight='600'>Смотреть видео</TitlePlay></WrapperTitlePlay>
                    </VideoBlock>
                </ViewBlock>
            </ContainerAboutSchool>
        </WrapperAboutSchool>
